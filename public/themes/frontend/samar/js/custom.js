var Samar = function(){
	...
	/* Handle Support ============ */
	var handleFooterWidget = function(){
		if(jQuery('.site-footer.style-2 .widget-title').length > 0){
			$('.site-footer.style-2 .widget-title').addClass('footer-title').removeClass('widget-title');
		}
	}
