        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div>
                        @can('Controllers > W3CPTController > create')
                            <a href="{{ route('cpt_taxo.admin.save') }}" class="btn btn-primary">{{ __('w3cpt::common.add_taxonomy') }}</a>
                        @endcan
                        <a href="{{ route('cpt.admin.trash_taxo_list') }}" class="btn btn-primary">{{ __('All Trash List') }}</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-responsive-lg mb-0">
                            <thead class="">
                                <tr>
                                    ...
                                    @canany(['Controllers > W3CPTController > edit', 'Controllers > W3CPTController > destroy'])
                                ...
                                @forelse ($allTxonomies as $taxo)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endcan
                                            @can('Controllers > BlogsController > trash_taxo')
