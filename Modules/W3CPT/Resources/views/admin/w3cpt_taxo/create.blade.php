                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check custom-checkbox">
                                                        <input type="checkbox" name="BlogMeta[cpt_tax_post_types][]" class="form-check-input" id="cpt_tax_post_types_post" value="post" @checked(in_array('post', $cpt_tax_post_types))> 
                                                        <label class="form-check-label" for="cpt_tax_post_types_post">{{ __('Posts') }}</label>
                                                    </div>
                                                    <div class="form-check custom-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="cpt_tax_post_types_page">{{ __('Pages') }}</label>
                                                    </div>
                                                    @forelse($blogs as $blogValue)
                                                        <div class="form-check custom-checkbox">
                                                            ...
                                                            <label class="form-check-label" for="cpt_tax_post_types_{{ $blogValue['cpt_name'] }}">{{ $blogValue['cpt_label'] }}</label>
                                                        </div>
                                                    @empty
                                                    @endforelse
                                                </td>
