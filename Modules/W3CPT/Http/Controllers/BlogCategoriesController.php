...
class BlogCategoriesController extends ModuleController
{
    public function list(Request $request, $id='')
    {
        ...
        if($request->isMethod('post'))
        {
            ...
            $validation = [
                'title'       => 'required',
                'slug'        => $id ? 'unique:terms,id,'.$id : 'unique:terms',
            ];
        ...
        return view('w3cpt::admin.blog_categories.list', compact('blog_categories', 'blogCategory','page_title', 'post_type', 'taxonomy'));
    }
    /**
