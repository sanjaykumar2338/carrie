		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-12">
						@php
							$ximageMeta = @$blog->feature_img->value;
							...
							<div class="accordion__body p-4 collapse show" id="with-feature-image" data-bs-parent="#accordion-feature-image">
								<div class="featured-img-preview img-parent-box">
									<div id="RemoveItemImg_{{ $blog->id }}">
										<img src="{{ DzHelper::getStorageImage('storage/blog-images/'.$ximageMeta) }}" class="avatar img-for-onchange"  alt="{{ __('common.image') }}" title="{{ __('common.image') }}">
									</div>
