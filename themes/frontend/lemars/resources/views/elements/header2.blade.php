			...
			<div class="row d-flex justify-content-between align-items-center">
				...
				<div class="dlab-topbar-right topbar-social">
					<ul>
	                    ...
	                    <li><a target="_blank" class="fab fa-linkedin" href="{{ config('Social.linkedin') }}" class="site-button-link" ></a></li>
            ...
            <div class="container">
				<div class="header-content-bx no-bdr">
					...
					<div class="header-nav navbar-collapse collapse justify-content-center" id="navbarNavDropdown">
						<div class="logo-header">
							<a href="{{ url('/') }}"><img src="{{ DzHelper::siteLogoLight() }}" alt="{{ __('Site Logo Full Image') }}"/></a>
						</div>
						{{ DzHelper::nav_menu(
						  	array(
